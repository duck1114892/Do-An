...
import { callChageStatus, callConfirm, callDeleteCart, callDeleteOrder, callGetCart, callOrdering, callUpdateOder } from '../../controller/api';
    ...
    const ConfirmOrder = async (id) => {
        try {
            ...
            if (resDelete.statusCode === 201) {
                console.log('this is form order page', resDelete)
        ...
        <div style={{ height: '600px', overflowY: 'auto' }}>
            ...
            <List
                ...
                renderItem={(item) => (
                    <List.Item
                        actions={[
                            <a onClick={() => ConfirmOrder(item.id)}>Xác Nhận</a>,
                            <UpdateOrder props={item.id}></UpdateOrder>
                        ]}
                    >
                        <List.Item.Meta
